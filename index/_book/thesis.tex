...
\begin{longtable}[t]{p{\dimexpr0.41\columnwidth-2\tabcolsep}p{\dimexpr0.59\columnwidth-2\tabcolsep}}
...
\begin{longtable}[t]{p{\dimexpr0.56\columnwidth-2\tabcolsep}p{\dimexpr0.11\columnwidth-2\tabcolsep}p{\dimexpr0.34\columnwidth-2\tabcolsep}}
...
{\centering \includegraphics{thesis_files/figure-latex/indel-1} 
...
{\centering \includegraphics{thesis_files/figure-latex/gwss-1} 
...
\CommentTok{#knitr::opts_knit$set(kable.force.latex = TRUE)}
