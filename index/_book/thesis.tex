...
% Everything below added by CII
  ...
  \NormalTok{knitr::opts_chunk$}\KeywordTok{set}\NormalTok{(}\DataTypeTok{fig.align =} \StringTok{'center'}\NormalTok{, }
  ...
  \NormalTok{knitr::opts_knit$}\KeywordTok{set}\NormalTok{(}\DataTypeTok{kable.force.latex =} \OtherTok{TRUE}\NormalTok{)}
