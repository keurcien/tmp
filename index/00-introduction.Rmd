...
La production de données génétiques, volumineuses par la quantité d'information qu'elles renferment, laisse présager le meilleur pour les domaines de la médecine clinique et de la biologie évolutive, pourvu qu'une attention toute particulière soit prêtée quant au traitement informatique et statistique de ces données. En génétique des populations, leur acquisition offre de nombreuses perspectives d'étude, notamment pour la mise en évidence de marqueurs génétiques impliqués dans les processus évolutifs. Au-delà de l'aspect théorique que ce travail de recherche nécessite, le développement et l'implémentation de méthodes computationnelles adéquates est primordial.
